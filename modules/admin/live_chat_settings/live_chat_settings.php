    ...
    <tr>
		...
		<td valign="top">
			<select name="uploadEnabled">
            	<option value="1"<? if ($chat_settings["uploadEnabled"] == 1) { echo " selected=\"selected\""; } ?>>Yes</option>
                <option value="0"<? if ($chat_settings["uploadEnabled"] == 0) { echo " selected=\"selected\""; } ?>>No</option>
            </select>
		</td>
    ...
    <tr>
		...
		<td valign="top">
			<select name="AdminDisplayName">
				<option value="fl"<? if ($chat_settings["AdminDisplayName"] == "fl") { echo " selected=\"selected\""; } ?>>First Name Last Name</option>
				<option value="lf"<? if ($chat_settings["AdminDisplayName"] == "lf") { echo " selected=\"selected\""; } ?>>Last Name First Name</option>
				<option value="f"<? if ($chat_settings["AdminDisplayName"] == "f") { echo " selected=\"selected\""; } ?>>First Name</option>
				<option value="l"<? if ($chat_settings["AdminDisplayName"] == "l") { echo " selected=\"selected\""; } ?>>Last Name</option>
			</select>
		</td>
        <td valign="top">
	...
	<tr>
		...
		<td valign="top">
			<select name="ClientDisplayName">
				<option value="fl"<? if ($chat_settings["ClientDisplayName"] == "fl") { echo " selected=\"selected\""; } ?>>First Name Last Name</option>
				<option value="lf"<? if ($chat_settings["ClientDisplayName"] == "lf") { echo " selected=\"selected\""; } ?>>Last Name First Name</option>
				<option value="f"<? if ($chat_settings["ClientDisplayName"] == "f") { echo " selected=\"selected\""; } ?>>First Name</option>
				<option value="l"<? if ($chat_settings["ClientDisplayName"] == "l") { echo " selected=\"selected\""; } ?>>Last Name</option>
			</select>
		</td>
        <td valign="top">
...
<table class="chat_settings_depart">
	<tr>
...
?>
	<tr>
		<td valign="top">
        	<? echo "<input type=\"hidden\" name=\"departments[".$row["id"]."][id]\" value=\"".$row["id"]."\" />"; ?>
			<?= $row["name"]; ?>
		</td>
		<td valign="top" align="center">
			<input type="checkbox" name="departments[<?= $row["id"]; ?>][live]"<? if ($row["allowlive"] == 1) { echo " checked=\"checked\""; }?> />
        </td>
        <td style="width: 100px;" align="center">
			<input type="radio" name="defaultDepartment" value="<?= $row["id"]; ?>" <? if ($chat_settings["defaultDepartment"] == $row["id"]) { echo "checked"; } ?>/>
        </td>
	</tr>
...
?>
	<tr>
    	<td colspan="3">
        <input type="checkbox" name="skipQuestions"<? if (strtolower($chat_settings["skipQuestions"]) == "on") { echo " checked=\"checked\""; }?> /> Skip selection when user is logged in.
        </td>
    </tr>
	<tr>
		<td valign="top" align="center" colspan="3">
